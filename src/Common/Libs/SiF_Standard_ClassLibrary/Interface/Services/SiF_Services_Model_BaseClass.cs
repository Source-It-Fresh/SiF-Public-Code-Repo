...
{
    public class SiF_Services_Model_BaseClass<T> : SiF_Services_Model_AbstractClass<T> where T : SiF_Models_BaseClass
    {
        ...
        public override Task<IEnumerable<T>> GetAllAsync(string UserId, int FilterId)
        {
            ...
            return Task.FromResult(returnValue.AsEnumerable());
        }

        public override Task<T> GetSpecificByIdAsync(string UserId, Guid ModelId)
        {
            T? returnValue = default(T);
            try
            {
                //base.GetSpecificById(UserId, ModelId);

                //ToDo:  override Task<T> GetById(Guid id)
                throw new NotImplementedException();
            }
            catch (Exception ex)
            {
        ...
        public override Task<bool> UpdateAsync(string UserId, T ModelToUpdate)
        {
            ...
            try
            {
                //base.UpdateAsync(UserId, ModelToUpdate);
        ...
        public override Task<bool> DeleteByIdAsync(string UserId, Guid ModelId)
        {
            bool returnValue = false;
            try
            {
                //base.DeleteByIdAsync(UserId, ModelId);

                //ToDo: override Task<bool> DeleteById(Guid id)
                throw new NotImplementedException();
            }
            catch (Exception ex)
            {
        ...
        public override Task<bool> ExistsAsync(string UserId, Guid ModelId)
        {
            bool returnValue = false;
            try
            {
                ...
                //ToDo: override bool Exists(Guid ModelId)
                throw new NotImplementedException();
            }
            catch (Exception ex)
            {
        ...
        public override Task<bool> HavePermissionAsync(string UserId, Guid ModelId)
        {
            bool returnValue = false;
            try
            {
        ...
        //public override Task<T> CloneAsync(string UserId, Guid IdToClone)
        //{
        //    T returnValue = null;
        //    try
        //    {
